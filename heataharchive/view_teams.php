...
<?php
  ...
  // output data of each row
    ...
    {
          //echo "0 results";
      //$imageNumber = "https://www.pokemon.com/static-assets/content-assets/cms2/img/pokedex/full/181_f2.png";
       }
...
<img class="icon" src="<?php echo $imageNumber ?>" alt="Not Found" onerror="this.src='images/fabio.jpg';" style="width:300px;height:270px;object-fit:cover">
